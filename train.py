...
transform = A.Compose([
    ...
    A.MotionBlur(blur_limit=37, p=0.5),
...
model_dict = {
    ...
    'decode_calss': dataset.decode_class,
}
...
for epoch in range(first_epoch, nb_epochs):
    for batch_index, (images, masks, filenames) in enumerate(dataloader):
        ...
        ious = iou_segmentation(true_class_vect, pred_class_vect)
        ...
        if nb_iter % 10 == 0:
            ...
            writer.add_image('data/pred_object', pred_obj, nb_iter)
